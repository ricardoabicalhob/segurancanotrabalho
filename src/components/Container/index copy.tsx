...
export default function ContainerTeste({ children, titulo, maximizableComponent, actions } :ContainerProps) {
    return(
        <div className={`flex flex-col items-center justify-start border-[1px] rounded-md min-w-full max-h-full max-w-full m-2`}>
