...
export default function DadosDaAnaliseDeRisco({  } :DadosDaAnaliseDeRiscoProps) {
    ...
    return(
        <div className="flex flex-col w-full h-full gap-3 p-2">

            {
                !risk
                ?
                <form id="formDadosDaAnaliseDeRisco" className="flex flex-col flex-grow basis-0 gap-4 p-2 custom-scrollbar overflow-y-auto">
                    <div className="">
                        <div className="grid w-full  items-center gap-1.5">
                            <div className="flex flex-row gap-2 items-center">
                                <CircleAlert className="text-yellow-500 w-4 h-4"/>
                                <label className="text-sm font-bold">Situação de risco</label>
                            </div>
