...
export default function IFrame() {
    ...
    return(
        <html lang="pt-BR">
            ...
            <body className="flex flex-col min-w-[100vw] min-h-full pt-10">  
                ...
                <main className="flex flex-row">
                    <div ref={frameLeftRef} className="print:hidden flex min-w-[17.6%] 2xl:w-[31%] min-h-full bg-customgray-1000" />
                    ...
                    <div ref={frameRightRef} className="print:hidden min-w-[19%] 2xl:w-[32%] min-h-full bg-customgray-1000" />
                </main>
            </body>
        </html>
    )
