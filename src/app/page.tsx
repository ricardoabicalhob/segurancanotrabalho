...
export default function Home() {
    ...
    return(
        <div className="flex flex-col w-screen h-[100vh - 60px] justify-center">
            ...
            {
                readyReport &&  <footer className={`bg-gray-100 p-6 mt-6 h-auto ${readyReport ? 'w-screen' : 'max-w-[960px]'}`}>
